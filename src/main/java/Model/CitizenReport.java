...
public class CitizenReport {
    ...
    public void selectTop5() {
        ...
        try (
            ...
            // Print header
            System.out.printf("%-15s%-20s%-20s%-10s%-15s%-30s%n", "Index", "Name", "Identity Card", "Sex", "Date of Birth", "Address");
            ...
            while (resultSet.next()) {
                ...
                // Print data in a formatted way
                System.out.printf("%-15d%-20s%-20s%-10s%-15s%-30s%n", index++, name, identityCard, sex, dateOfBirth, address);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
