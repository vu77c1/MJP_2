...
public class DistributionManager {
    ...
    public static Map<Integer, Distribution> getDistribution(Connection con) {
        ...
        try {
            String selectQuery = """
                    SELECT  Distribution.id, precint_name, city_name,province_name,Distribution.commission_id as commission_id , household_id,Ci.is_household_lord,Ci.name as name, amount_received, date_received
